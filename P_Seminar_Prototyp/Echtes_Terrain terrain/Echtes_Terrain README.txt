...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Echtes_Terrain&box=12.924169,47.899942,12.575792,47.666381
...
-----------
  ...
  * Echtes_Terrain Height Map (ASTER 30m).png
  ...
  * Echtes_Terrain Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Echtes_Terrain Height Map (SRTM3 v4.1).png
  ...
  * Echtes_Terrain Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 406m (actual) is equal to 40m in
